...
const handleCategoryMessage = async (msg) => {
  try {
    ...
    let bookList = foundBookData;
    console.log("bookList>>>>>>>>",foundBookData)
...
const messageHandler = async (msg) => {
  await userRequests.createUser(msg.from);
  console.log("msg.text in message handler client>>>>>>.",msg.text)
  console.log("msg.chat.text in message handler client>>>>>>.",msg && msg.chat && msg.chat.text)
